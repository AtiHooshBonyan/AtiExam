        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredQuestion = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserResponses", x => x.SelectedOptionId);
                    table.ForeignKey(
                        name: "FK_UserResponses_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserResponses_Exams_ExamId1",
                        column: x => x.ExamId1,
                        principalTable: "Exams",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptions_QuestionId_OptionId",
                table: "QuestionOptions",
                columns: new[] { "QuestionId", "OptionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserResponses_ExamId",
                table: "UserResponses",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_UserResponses_ExamId1",
                table: "UserResponses",
                column: "ExamId1");
